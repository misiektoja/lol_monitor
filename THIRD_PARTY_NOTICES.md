...
lol_monitor original code is licensed under GPL-3.0-or-later. See [LICENSE](LICENSE).
...
| --- | --- | --- |
| [pulsefire](https://pypi.org/project/pulsefire/) | MIT | Riot Games API client for summoner and match retrieval |
...
The tool contacts Riot Games. Optional notification delivery contacts the SMTP server or webhook endpoint you configure. Nothing is sent anywhere you have not configured.
